...
# ApprovalTests.CommonScripts Documentation
...
* [How to Run](how_to/run.md)

## Reference

* [Agents](agents.md) - AI agent instructions and script documentation
* [Map](map.md) - Codebase structure overview
